...
class Editor extends Component {
  ...
  componentDidMount() {
    ...
    if (Object.keys(params).length > 0) {
      ...
      managers.getManager(managerId).then(result => {
  ...
  onBlockManager = event => {
    ...
    return managers.blockManager(managerId).then(() => {
  ...
  onSave = event => {
    ...
    const func =
      action === 'edit' ? managers.saveManager(body, managerId) : managers.saveManager(body);
