...
import { Login, Passwords } from '../../features/profile/components';
    ...
    <Card.List>
      <Card.List.Item>
        <Card.Form noValidate>
          ...
          <Login login={login} onChangeInput={onChangeInput} validatorProfile={validator} />
          {action === 'add' && (
            <Card.Form.Item>
      ...
      <Card.List.Item>
        <Card.Form noValidate>
          <Card.Form.Item>
            ...
            <Input type="checkbox" name="isBlocked" onChange={onChangeInput} checked={isBlocked} />
          </Card.Form.Item>
          <Card.Form.Item>
